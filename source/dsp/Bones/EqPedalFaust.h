...
Compilation options: -a .\faustMinimal.h -lang cpp -i -fpga-mem-th 4 -ct 1 -cn EqPedalEngine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __EqPedalEngine_H__
#define  __EqPedalEngine_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS EqPedalEngine
#endif
...
static float EqPedalEngine_faustpower2_f(float value) {
	return value * value;
}

class EqPedalEngine : public dsp {
 ...
 public:
	...
	EqPedalEngine(const EqPedalEngine&) = default;
	
	virtual ~EqPedalEngine() = default;
	
	EqPedalEngine& operator=(const EqPedalEngine&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a .\faustMinimal.h -lang cpp -i -fpga-mem-th 4 -ct 1 -cn EqPedalEngine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual EqPedalEngine* clone() {
		return new EqPedalEngine(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 2.0f * (1.0f - 1.0f / EqPedalEngine_faustpower2_f(fSlow0));
