...
#ifndef  __CompressorPedalEngine_H__
#define  __CompressorPedalEngine_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS CompressorPedalEngine
#endif
...
class CompressorPedalEngine : public dsp {
 ...
 public:
	...
	CompressorPedalEngine(const CompressorPedalEngine&) = default;
	
	virtual ~CompressorPedalEngine() = default;
	...
	virtual CompressorPedalEngine* clone() {
		return new CompressorPedalEngine(*this);
	}
