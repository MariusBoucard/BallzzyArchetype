namespace OverdrivePedal {
/* ------------------------------------------------------------
name: "OverdrivePedalEngine"
Code generated with Faust 2.83.1 (https://faust.grame.fr)
Compilation options: -a .\faustMinimal.h -lang cpp -i -fpga-mem-th 4 -ct 1 -cn OverdrivePedalEngine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __OverdrivePedalEngine_H__
#define  __OverdrivePedalEngine_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS OverdrivePedalEngine
#endif
...
static float OverdrivePedalEngine_faustpower2_f(float value) {
	return value * value;
}

class OverdrivePedalEngine : public dsp {
 ...
 public:
	OverdrivePedalEngine() {
	}
	
	OverdrivePedalEngine(const OverdrivePedalEngine&) = default;
	
	virtual ~OverdrivePedalEngine() = default;
	
	OverdrivePedalEngine& operator=(const OverdrivePedalEngine&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a .\faustMinimal.h -lang cpp -i -fpga-mem-th 4 -ct 1 -cn OverdrivePedalEngine -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "OverdrivePedalEngine.dsp");
		...
		m->declare("name", "OverdrivePedalEngine");
	...
	virtual OverdrivePedalEngine* clone() {
		return new OverdrivePedalEngine(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("OverdrivePedalEngine");
		ui_interface->declare(&fHslider1, "1", "");
		ui_interface->addHorizontalSlider("Drive", &fHslider1, FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider0, "2", "");
		ui_interface->addHorizontalSlider("Tone", &fHslider0, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = std::tan(fConst1 * (56.0f * static_cast<float>(fHslider0) + 4e+02f));
		float fSlow1 = 2.0f * (1.0f - 1.0f / OverdrivePedalEngine_faustpower2_f(fSlow0));
		float fSlow2 = 1.0f / fSlow0;
		float fSlow3 = (fSlow2 + -1.4142135f) / fSlow0 + 1.0f;
		float fSlow4 = (fSlow2 + 1.4142135f) / fSlow0 + 1.0f;
		float fSlow5 = 1.0f / fSlow4;
		float fSlow6 = std::pow(1e+01f, 0.02f * static_cast<float>(fHslider1));
		float fSlow7 = static_cast<float>(fHslider2);
		float fSlow8 = 0.01f * (fSlow7 / fSlow4);
		float fSlow9 = 1.0f - 0.01f * fSlow7;
		float fSlow10 = std::pow(1e+01f, 0.05f * static_cast<float>(fHslider3));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = static_cast<float>(input0[i0]);
			fVec0[0] = fTemp0;
			fRec1[0] = -(fConst4 * (fConst3 * fRec1[1] - fConst2 * (fTemp0 - fVec0[1])));
			fRec0[0] = tanhf(fSlow6 * fRec1[0]) - fSlow5 * (fSlow3 * fRec0[2] + fSlow1 * fRec0[1]);
			output0[i0] = static_cast<FAUSTFLOAT>(fSlow10 * (fSlow9 * fTemp0 + fSlow8 * (fRec0[2] + fRec0[0] + 2.0f * fRec0[1])));
			fVec0[1] = fVec0[0];
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
